      ...
      <div class="product-card">
          <div class="column-one col-sm-4">
              ...
              <div class="column-two">
                  ...
                  <h6 class="price">₱&nbsp;${data.cost}</h6>
                  <h6 class="total">₱&nbsp;${(data.cost * data.qty).toFixed(
                    2
                  )}</h6>
                  </div>
...
function POS() {
  if (ITEMS.length > 0) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        setTimeout(function () {
          window.top.location = "index.php?pg=pos";
        }, 2000);
        Swal.fire("Welcome to POS!", "Successfully access POS", "success");
      }
    });
  }
}

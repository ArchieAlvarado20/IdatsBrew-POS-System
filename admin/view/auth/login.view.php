                    ...
                    <form method="post">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                          <div class="row-sm-12 d-flex">
                              <img src="assets/img/idatsLogo.png" alt="Logo" style="width: 50px; height: 50px;" class="col-sm-1">&nbsp;
                              <h3 class="text-primary col-sm-11 mt-3"><?=esc(APP_NAME)?></h3>
                          </div>
                        ...
                        <input  value="<?=set_value('password')?>" type="password" name="password"  id="floatingPassword" class="form-control <?=!empty($error['password']) ? 'border-danger' : '' ;?>" id="exampleFormControlInput1" placeholder="Password">

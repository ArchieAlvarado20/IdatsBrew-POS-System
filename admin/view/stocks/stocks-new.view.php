      ...
      <div class="container col-md-6" >
        ...
        <div class="card-header mb-0">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          <button type="button" class="btn btn-dark text-primary float-end px-4 " onclick="stocked_success(event)">Complete</button>
                        </div>
                      </div>
                      </form>
        </div>
     ...
     function stocked_success()
     {
      ...
      if(ITEMS.length == 0){
               ...
               Swal.fire({
                    ...
                    if (result.isConfirmed) {
                      stocked(),
                      setTimeout(function(){window.top.location="index.php?pg=inventory"} , 1500);
                        Swal.fire(
                        'Saved!',

      ...
      <div class="container col-md-12">
        <div class="card shadow bg-secondary p-3">
              ...
              <div class="card-header mb-2">
                      <div class="row-23 mb-2 d-flex">
                        <div class="col-10">
                          <h4 class="fw-bold text-primary" style="font-weight: bolder;"><strong><i class="fa fa-chart-simple"></i> Stocks List</strong></h4> 
                        </div>
                        <div class="col-2">
                          <a href="index.php?pg=stocks"><button class="btn btn-dark text-primary px-3 float-end">Add Stocks</button></a>
                        </div>
                      </div>
                    </div>
              <div class="card-body">

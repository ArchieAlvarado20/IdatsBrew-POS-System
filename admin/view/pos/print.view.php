...
<?php if(is_array($obj)): date_default_timezone_set("Asia/Manila");?>
	...
	<tr style="height: 10px;"></tr>
		...
		<center><td class="text-dark">Number: <b><?= $obj['table']?></b></td><br></center>
		<center><td>Server: <?php echo auth('name') ?></td><br></center>
		<center><td>Country Meadow Gate, Arnaldo Hwy. Gen. Trias Cavite</td><br></center>
		<center><td>Thank you very much!</td></center>
		<center><td>...</td></center>

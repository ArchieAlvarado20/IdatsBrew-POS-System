            ...
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.php?pg=home" class="navbar-brand mx-4 mb-3">
                    <div class="row-sm-12 d-flex">
                        <img src="assets/img/idatsLogo.png" alt="Logo" style="width: 40px; height: 40px;" class="col-sm-1">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="index.php?pg=cancelled-items" class="dropdown-item <?= $tab == 'cancelled-items' ? 'active' : '';?>">Cancelled Items</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                        <a href="index.php?pg=inventory" class="dropdown-item <?= $tab == 'inventory' ? 'active' : '';?>">Stocks List</a>
                            <a href="index.php?pg=stocks" class="dropdown-item <?= $tab == 'stocks' ? 'active' : '';?>
                                                        ...
                                                        <?= $tab == 'reference-new'? 'active' : '';?>
                                                        <?= $tab == 'reference-update'? 'active' : '';?>">Reference</a>
                    ...
                    <a href="index.php?pg=user" class="nav-item nav-link <?= $tab == 'user' ? 'active' : "" ;?>
                         ...
                         <button href="" class="nav-item nav-link bg-secondary border-none mt-2 logout" onclick="logout()"><i class="fa fa-arrow-right me-2"></i>Logout</button>
                    </div>
